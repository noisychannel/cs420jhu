...
* Action: flattened for loop in Fortran (column major) order
*-----------------------------------------------------------------------------*/
...
* Action: Calls smoothParallelYXFor twice
*-----------------------------------------------------------------------------*/
...
* Action: Calls components of smoothParallelYXFor twice in one loop
*-----------------------------------------------------------------------------*/
